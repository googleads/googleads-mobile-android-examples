...
import com.google.android.gms.example.jetpackcomposedemo.composables.TextButton
  ...
  fun MainScreen() {
    ...
    Column(
      ...
      content = {
        ...
        StatusText(
          adsManager.mobileAdsState.intValue.messageColor(),
          adsManager.mobileAdsState.intValue.messageText(),
        )
        // Show Consent Form.
        TextButton(
