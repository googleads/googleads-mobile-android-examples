...
fun HomeScreen(
  ...
  Column {
    Button(
      ...
      Text(stringResource(R.string.nav_admanager_banner))
    }
    Button(
      ...
      Text(stringResource(R.string.nav_banner))
    }
    Button(
      ...
      Text(stringResource(R.string.nav_lazy_banner))
    }
    Button(
      ...
      Text(stringResource(R.string.nav_native))
    }
  }
}
