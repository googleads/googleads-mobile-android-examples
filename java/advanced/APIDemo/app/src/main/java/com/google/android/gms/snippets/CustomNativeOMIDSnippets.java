...
public class CustomNativeOMIDSnippets {
  ...
  private FrameLayout nativeCustomFormatAdContainer;

  private void loadCustomNativeAd(Context context, FrameLayout container) {
  ...
  private void registerOpenMeasurement(NativeCustomFormatAd ad) {
    // [START register_open_measurement]
    ad.getDisplayOpenMeasurement().setView(nativeCustomFormatAdContainer);
    // [END register_open_measurement]
  }

  private void startOpenMeasurement(NativeCustomFormatAd ad) {
