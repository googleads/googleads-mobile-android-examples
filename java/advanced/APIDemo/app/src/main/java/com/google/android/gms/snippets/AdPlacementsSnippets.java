...
public class AdPlacementsSnippets {
  ...
  private final InterstitialAdLoadCallback loadCallback = new InterstitialAdLoadCallback() {};

  // [START load_interstitial]
  private void loadInterstitial(Context context, InterstitialAd interstitial) {
  ...
  // [START load_banner]
  private void loadBannerView(AdView adView) {
