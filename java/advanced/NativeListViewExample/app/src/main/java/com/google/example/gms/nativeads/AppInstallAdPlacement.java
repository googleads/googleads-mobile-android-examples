...
/**
 * The {@link AppInstallAdPlacement} class represents a single placement of an App Install ad. It
 * returns a {@link View} that contains a previously loaded ad or will be filled with a new ad once
 * it completes loading.
 */
public class AppInstallAdPlacement implements AdPlacement {

    private AppInstallAdFetcher mFetcher;

    /**
     * Creates a new instance of {@link AppInstallAdPlacement} with the given fetcher
     *
